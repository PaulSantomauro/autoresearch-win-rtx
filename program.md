...
3. git commit
4. Run the experiment: `PYTORCH_ALLOC_CONF='' /c/Users/pauls/.local/bin/uv.exe run train.py --dataset franchise > run.log 2>&1` (redirect everything — do NOT use tee or let output flood your context)
